<template>
  ...
  >
    ...
    <div class="sp-wallet-menu-items">
      <template v-if="topWallet">
        ...
        >
          ...
          <div class="sp-wallet-menu-item__info">
            ...
            <span class="sp-text" v-else> 已锁 </span>
          </div>
      ...
      //-->
      <div class="sp-wallet-menu-action">
        <SpLinkIcon icon="AddNew" text="添加新钱包" v-on:click="createNewWallet" />
      </div>
    </div>
  </div>
    ...
    <div class="sp-wallet-menu-items">
      <div class="sp-wallet-menu-item">
        ...
        <div class="sp-wallet-menu-item__info">
          ...
          <br />
          <span class="sp-text"> 锁定 </span>
        </div>
      </div>
    </div>
    <div class="sp-wallet-menu-unlock">
      <div class="sp-wallet-menu-unlock__title sp-header-text">解锁钱包</div>
      <div class="sp-wallet-menu-unlock__text">
        输入密码
      </div>
      <div class="sp-wallet-menu-unlock__form">
        <div class="sp-form-group">
          <input class="sp-input" v-model="password" type="password" name="password" placeholder="密码" />
        </div>

        <SpButton v-on:click="unlockStoreWallet" type="primary">解锁钱包</SpButton>
      </div>
    </div>
  </div>
</template>
