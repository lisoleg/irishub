      ...
      <div class="sp-amount-select__denom" :class="{ 'sp-focused': focused }">
        <div class="sp-amount-select__denom__selected" v-on:click="toggleModal">
          ...
          <div class="sp-amount-select__denom__controls">
            <div class="sp-amount-select__denom__remove" v-if="modalOpen && !last" v-on:click="selfRemove">移除</div>
            <span
              :class="{
        ...
        <div class="sp-amount-select__denom__modal" v-if="modalOpen">
          ...
          <div class="sp-amount-select__denom__modal__header">
            <div class="sp-amount-select__denom__modal__header__token">卡券</div>
            <div class="sp-amount-select__denom__modal__header__amount">品种</div>
          </div>
          <div
...
export interface SpNFTAmountSelectState {
  amount: string | null
  denom: string | null
  focused: boolean
  modalOpen: boolean
...
export default defineComponent({
  ...
  data: function (): SpNFTAmountSelectState {
    return {
      amount: null,
      denom: null,
      focused: false,
